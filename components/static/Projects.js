...
import styles from '../sass/projects.scss';
...
class Projects extends React.Component {
  render() {
    ...
    const expressGalleryElement = (
      <div id={styles.expressGallery}>
        <div className={styles.overlay}>
          <div className={styles.description}>
            <a href="http://expressgallery.reneey.com" className={styles.projectLinks}>Gallery platform for artists</a>
          </div>
          <a href="https://github.com/jcarreon808/express-gallery">
            <div className={styles.githubLink}></div>
          </a>
        </div>
      </div>
    ...
    return (
      <div id={styles.container}>
        <ul id={styles.projects}>
          ...
          <li>{expressGalleryElement}</li>
          <li className={styles.mobileDescription}>
            <p>Gallery platform for artists</p>
            <a href="http://expressgallery.reneey.com" className={styles.mobileLink}>Visit</a>
            <a href="https://github.com/jcarreon808/express-gallery">
              <div className={styles.mobileGithubLink}>
              </div>
            </a>
